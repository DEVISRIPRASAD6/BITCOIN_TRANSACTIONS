...
RPC_PASSWORD = "12345"
RPC_PORT = 18443
RPC_URL = f"http://{RPC_USER}:{RPC_PASSWORD}@127.0.0.1:{RPC_PORT}/wallet/testwallet"
...
def main():
    try:
        print("🔹 Loading Wallet 'testwallet'...")
        if "testwallet" not in rpc_connection.listwallets():
            raise Exception("Wallet 'testwallet' is not loaded!")
